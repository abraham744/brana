    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='pic_folder/', verbose_name='upload your files')),
                ('video', models.FileField(blank=True, null=True, upload_to='dox_folder/', verbose_name='upload your files')),
                ...
                ('saved', models.ManyToManyField(related_name='favorited', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
